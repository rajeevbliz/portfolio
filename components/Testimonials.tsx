...
const testimonials = [
  ...
  {
    id: 2,
    content: "Working with Rajeev on the Bliz X Fitness app was a game-changer. His 'vibe coding' approach meant we moved from concept to MVP in record time.",
    author: "Priya Nair",
  ...
  {
    id: 4,
    content: "Precision, speed, and a deep understanding of modern tech stacks. Rajeev is the generalist builder every startup needs in their corner.",
    author: "Rohan Gupta",
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
          <motion.div
            ...
            className="max-w-2xl"
          >
            <h2 className="text-5xl md:text-8xl font-black tracking-tighter text-matteBlack dark:text-white leading-[0.8] mb-6">
              VOICES OF <br />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {testimonials.map((t, index) => (
            <motion.div
              ...
              className="relative p-10 rounded-[2.5rem] bg-white dark:bg-zinc-900 border border-black/5 dark:border-white/5 shadow-sm hover:shadow-xl dark:hover:shadow-white/5 transition-all duration-500 group"
            >
